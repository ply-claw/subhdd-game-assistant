...
const Panel = {
  ...
  renderLoading(gameType) {
    const names = { puzzle2048: '2048', memory: '记忆翻牌', puzzle15: '华容道', sudoku: '数独', tile: '羊了个羊', minesweeper: '扫雷', sokoban: '推箱子', lightsout: '点灯', maze: '迷宫', nonogram: '数织', flowfree: '连线' };
    this.setBody(`
      <div class="ga-status-row" id="ga-status-row">
